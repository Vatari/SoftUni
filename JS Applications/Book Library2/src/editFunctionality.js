import { editExerciseReuest, getExercise, } from './requests.js'
import { displayForm, } from './helper.js'

async function displayEditForm (id, submitForm, editForm) {
	const bookData = await getExercise(id)
...
async function editExercise (e, data, submitForm, editForm) {
	await editExerciseReuest(sessionStorage.getItem('editID'), data)
	displayForm(submitForm, editForm)
}

export { displayEditForm, editExercise }